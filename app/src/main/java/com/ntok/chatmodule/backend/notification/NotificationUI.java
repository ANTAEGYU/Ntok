package com.ntok.chatmodule.backend.notification;
...
public class NotificationUI {
     ...
     * @see #cancel(Context)
     */
    public static void notifywithImage(final Context context, final String title,
                                       final String text, final int number, int image) {
    ...
    public static void sendNotification(String messageBody, Context context) {
        Intent intent = new Intent(context, NotificationUI.class);
