...
public class ChatProfileHeaderBehaviourView extends CoordinatorLayout.Behavior<HeaderView> {
    ...
    public ChatProfileHeaderBehaviourView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public ChatProfileHeaderBehaviourView(Context context, AttributeSet attrs, Context mContext) {
        super(context, attrs);
