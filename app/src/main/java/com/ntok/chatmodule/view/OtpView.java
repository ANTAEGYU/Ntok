...
import com.ntok.chatmodule.interfaces.OtpListener;
...
public class OtpView extends LinearLayout {
    ...
    private void generateViews(TypedArray styles) {
        if (length > 0) {
            int width = (int) styles.getDimension(R.styleable.OtpView_width, getPixels(30));
            int height = (int) styles.getDimension(R.styleable.OtpView_height, getPixels(30));
