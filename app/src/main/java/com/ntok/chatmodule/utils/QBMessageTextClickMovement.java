...
import com.ntok.chatmodule.interfaces.QBChatMessageLinkClickListener;
...
//                Lg.d("Long Click Occurs on TextView with ID: " + textView.getId() +
//                        " Text: " + text);
//
...
//            }
        ...
        public boolean onSingleTapConfirmed(MotionEvent event) {
            ...
            if (linkClickListener != null) {
                Lg.d("Tap Occurs on TextView with ID: " + textView.getId() +
                        " Link Text: " + linkText +
                        " Link Type: " + linkType +
