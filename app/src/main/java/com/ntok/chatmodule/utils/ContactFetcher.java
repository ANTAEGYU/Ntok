...
import com.ntok.chatmodule.model.Contact;
...
public class ContactFetcher {
    ...
    public ArrayList<Contact> fetchAll() {
        ...
        if (c.moveToFirst()) {
            ...
            int imageIndex = c.getColumnIndex(ContactsContract.Contacts.PHOTO_URI);

            do {
                String contactId = c.getString(idIndex);
                String contactDisplayName = c.getString(nameIndex);
                String contactDisplayImage = c.getString(imageIndex);

                Contact contact = new Contact(contactId, contactDisplayName,contactDisplayImage);
