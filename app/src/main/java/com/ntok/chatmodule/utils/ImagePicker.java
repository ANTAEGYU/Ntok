...
public class ImagePicker {
    ...
    private static final String TEMP_IMAGE_NAME = "abc.jpg";
    private static final int CROPING_CODE = 2345;
    ...
    public static Intent getPickImageIntent(Context context, String type) {
        ...
        if (intentList.size() > 0) {
            chooserIntent = Intent.createChooser(takePhotoIntent, "Choose");
...
/** ALBUM **/
    ...
    public static String getTempFilee(Context context) {
        String timeStamp =
